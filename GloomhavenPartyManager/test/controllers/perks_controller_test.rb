...
class PerksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perk" do
    assert_difference('Perk.count') do
      post perks_url, params: { perk: { character_class_id: @perk.character_class_id, count: @perk.count, description: @perk.description, effects: @perk.effects } }
    end
  ...
  test "should update perk" do
    patch perk_url(@perk), params: { perk: { character_class_id: @perk.character_class_id, count: @perk.count, description: @perk.description, effects: @perk.effects } }
